...
contract TestStaking is Initializable, OwnableUpgradeable, IERC721ReceiverUpgradeable {
    ...
    // user => tokenIds
    mapping(address => uint256) public passiveTokenProxies;
    ...
    function withdrawActive() external {
        ...
        passiveTokenProxies[msg.sender] -= arrLen;
    ...
    function withdrawLock() external {
        ...
        if (lockArrLength == 0) {
            ...
            passiveTokenProxies[msg.sender] -= _stakelockTokens.length;
